...
const total = yogaGroupClass * 3 + weightTrainGroupClass * 1 + weightTrainOneToOneClass * 1;
const AlexBudget = sportBudget - total;
console.log(`Alex 買完課程了，他一共剩下 ${AlexBudget} 元`);

// ### 題目四：線稿圖截圖，看圖宣告變數
// 請參考資料夾內 q4.webp 圖片
// 請依照你看到的內容來嘗試設計變數和值（至少 3 個）
const name = '14 堂組合包方案';
const price = 2520;
const discount = 0.9;
...
console.log(`Alex 的水壺還有 ${myWater}cc 的水`);  // 顯示水壺剩餘的水量
...
const groupClassesTotal = groupClass * 2;
...
let numberArr1 = [5, 10, 15]; // 宣告一個 numberArr1 的變數，並賦予初始值 [5, 10, 15] 的陣列
let numberArr2 = numberArr1;  // 宣告一個 numberArr2 的變數，並將其指向 numberArr1
numberArr2.push(20);          // 在 numberArr2 的陣列中新增數值 20 
numberArr2 = [25, 30, 35];    // 將 numberArr2 重新指向一個新的陣列 [25, 30, 35]
console.log(numberArr1, numberArr2);  // numberArr1 顯示為 [5, 10, 15, 20]，numberArr2 顯示為 [25, 30, 35]